    ...
    <section className="bg-vibe-dark py-24 md:py-32 relative overflow-hidden">
      ...
      <div className="vibe-container px-6 relative">
        <div className="max-w-4xl mx-auto">
          {/* The big quote */}
          <div className="aura-reveal text-center mb-16">
          ...
          {/* The explanation */}
          <div className="aura-reveal aura-reveal-delay-2 max-w-3xl mx-auto">
          ...
          {/* The punchline */}
          <div className="aura-reveal aura-reveal-delay-3 mt-16 text-center">
