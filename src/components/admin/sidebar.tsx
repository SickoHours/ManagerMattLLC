...
const configNavigation = [
  { name: "Modules", href: "/admin/config/modules", icon: Boxes },
  { name: "Rate Cards", href: "/admin/config/rates", icon: CreditCard },
];
  ...
  return (
    <div className="flex h-full w-64 flex-col bg-zinc-900 border-r border-zinc-800">
      ...
      <div className="flex h-16 items-center gap-2 px-6 border-b border-zinc-800">
        ...
        <div>
          <div className="text-sm font-semibold text-white">Manager Matt</div>
      ...
      <div className="border-t border-zinc-800 p-4">
        <div className="flex items-center gap-3">
          ...
          <div className="flex-1 min-w-0">
            <div className="text-sm font-medium text-white truncate">Matt</div>
